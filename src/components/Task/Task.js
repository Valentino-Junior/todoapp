            ...
            <div className='task-container'>
                <div className='task-container-background' style={{backgroundColor: this.state.backgroundColor}}>
                    ...
                    <div className='buttons-container'>
                        <button className='done-button' onClick={this.markDone}><span className='mark'>✔</span></button>
                        <button className='delete-button' onClick={this.removeTask}><span className='del'>x</span></button>
                    </div>
                </div>
            </div>
        );
